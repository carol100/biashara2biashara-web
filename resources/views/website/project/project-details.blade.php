...
@section('content')
    ...
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container">
        ...
        <div class="content flex-row-fluid" id="kt_content">
                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6 active" href="{{ route('project.details', ['id'=>$grant_project->id]) }}">Overview</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6" href="{{ route('project.files', ['id'=>$grant_project->id]) }}">Project Files</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
            ...
            <website-project-details-component id="{{ $grant_project->id }}" api_token="{{ Auth::user()->api_token }}"></website-project-details-component>
