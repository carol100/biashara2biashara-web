...
@section('content')
    ...
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container">
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="row gx-5 mb-5 gx-xl-8">
                <!--begin::Col-->
                <div class="col-xxl-4">
                    ...
                    <a href="#" class="card bg-primary card-xxl-stretch">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-inverse-primary fw-bolder fs-1 mb-2 mt-5">800</div>
                            <div class="fw-bold text-inverse-primary fs-6">Users</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Tiles Widget 5-->
                ...
                <div class="col-xxl-4">
                    ...
                    <a href="#" class="card bg-bg-body card-xxl-stretch">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-inverse-bg-body fw-bolder fs-1 mb-2 mt-5">800</div>
                            <div class="fw-bold text-inverse-bg-body fs-6">Employees</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Tiles Widget 5-->
                ...
                <div class="col-xxl-4">
                    <!--begin::Tiles Widget 5-->
                    <a href="#" class="card bg-danger card-xxl-stretch">
                        <!--begin::Body-->
                        <div class="card-body">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                            <span class="svg-icon svg-icon-success svg-icon-2hx ms-n1">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-inverse-primary fw-bolder fs-1 mb-2 mt-5">800</div>
                            <div class="fw-bold text-inverse-primary fs-6">Meetings</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Tiles Widget 5-->
                    ...
                    <div class="card card-xxl-stretch">
                        ...
                        <div class="card-header align-items-center border-0 mt-4">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="fw-bolder mb-2 text-dark">Digital Advocacy Calender</span>
                                <span class="text-muted fw-bold fs-7">890,344 upcoming</span>
                            </h3>
                            <div class="card-toolbar">
                                ...
                                <!--begin::Menu 1-->
                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_610d49649b7f6">
                                    <!--begin::Header-->
                                    <div class="px-7 py-5">
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <div>
                                                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_610d49649b7f6" data-allow-clear="true">
                                                    <option></option>
                        ...
                        <div class="card-body d-flex flex-column p-0">
                            ...
                            <div class="flex-grow-1 card-p pb-0">
                                <div class="d-flex flex-stack flex-wrap">
                                    <div class="me-2">
                                        <a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Recent Memos</a>
                                        <div class="text-muted fs-7 fw-bold">Published Memos</div>
                                    </div>
                                    <div class="fw-bolder fs-3 text-primary">500</div>
                                </div>
                            </div>
                            <!--end::Stats-->
                            <!--begin::Chart-->
                    ...
                    <div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
                        ...
                        <div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            ...
                            <div class="d-flex flex-stack flex-wrap flex-grow-1 px-9 pt-9 pb-3">
                                <div class="me-2">
                                    <span class="fw-bolder text-gray-800 d-block fs-3">Scheduled Events</span>
