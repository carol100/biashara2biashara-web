...
var KTSweetAlert2Demo = function () {
	var _init = function () {
		...
		$('#kt_sweetalert_demo_3_1').click(function (e) {
			Swal.fire("Success!", "You clicked the button!", "warning");
		});

		$('#kt_sweetalert_demo_3_2').click(function (e) {
			Swal.fire("Success!", "You clicked the button!", "error");
		});
		...
		$('#kt_sweetalert_demo_3_4').click(function (e) {
			Swal.fire("Success!", "You clicked the button!", "info");
		});

		$('#kt_sweetalert_demo_3_5').click(function (e) {
			Swal.fire("Success!", "You clicked the button!", "question");
		});
